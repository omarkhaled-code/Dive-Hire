        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
            ...
            <div class="md:col-span-4 flex flex-col items-center">
                <div
                    ...
                    <div
                        class="w-24 h-24 rounded-full bg-primary-fixed flex items-center justify-center mb-6 group-hover:scale-110 transition-transform"
            ...
            <div class="md:col-span-8 space-y-8">
                <div
                    ...
                    <div class="space-y-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            <div class="relative group">
                                <label class="block text-xs font-bold text-primary uppercase tracking-widest mb-2">Phone</label>
                                <input
                            ...
                            <div class="relative group">
                                <label
                                    class="block text-xs font-bold text-primary uppercase tracking-widest mb-2">Job Title</label>
                                <input
                                    class="w-full bg-transparent border-0 border-b-2 border-outline-variant/30 focus:ring-0 focus:border-primary py-3 px-0 text-on-surface font-medium placeholder:text-outline-variant transition-all"
                                    placeholder="e.g. Software Engineer" type="text"
                        ...
                        <div class="relative group">
                            ...
                            <div class="flex justify-end mt-2">
                                <span class="text-[10px]  font-bold uppercase tracking-widest" :class="numberOfDescChars >= 500 ? 'text-red-500':'text-on-surface-variant'">{{numberOfDescChars}}
                                    / 500
                                    characters</span>
                            </div>
                        </div>
